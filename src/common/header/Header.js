...
const TabContainer = function(props) {
  return (
    <Typography
      component="div"
      style={{ padding: 0, textAlign: "center", width: "parent" }}
    >
      {props.children}
    </Typography>
  );
...
class Header extends Component {
  ...
  loginClickHandler = () => {
    ...
    this.state.username === ""
      ...
      : this.state.username.match(contactRegx)
      ? this.setState({
          usernameRequired: "dispNone",
          isLoggedInContactValid: "dispNone"
        })
      : this.setState({
          usernameRequired: "dispNone",
          isLoggedInContactValid: "dispBlock"
        });
  ...
  validateSignUp() {
    ...
    this.state.registerPassword === ""
      ...
      : this.state.registerPassword.match(passwordRegx)
      ? this.setState({
          isPassValid: "dispNone",
          registerPasswordRequired: "dispNone",
          formValid: this.state.formValid ? true : true
    ...
    this.state.contact === ""
      ...
      : this.state.contact.match(contactRegx)
      ? this.setState({
          isContactValid: "dispNone",
          contactRequired: "dispNone",
          formValid: this.state.formValid ? true : true
  ...
  signUp(dataSignup) {
    ...
    xhrSignup.open(
      "POST",
      this.props.baseUrl + resourcePath + "?" + dataSignup.toString()
    );
    ...
    return (
      <div className="row">
        <div className="logo col-md-5">
          {" "}
          <Fastfood nativeColor="white" fontSize="large" />{" "}
        </div>
